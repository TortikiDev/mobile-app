    ...
    Future.delayed(Duration(seconds: 2)).then(
      (value) => RecipeResponse(
        ...
        userAvaratUrl:
            'https://images.unsplash.com/photo-1486427944299-d1955d23e34d',
        userName: 'Мила Кунис',
        description: 'Чтобы придать обычным кексам более эффектный внешний '
            'вид, вмешайте в часть теста растопленный шоколад и немного какао. '
            ...
            'изумительным сочетанием ванили и шоколада. Украсьте их шоколадной'
            ' глазурью, окунув в ганаш лишь верхушки кексов, чтоб сбоку '
            'оставался видным их мраморный узор.',
        ingredients: [
